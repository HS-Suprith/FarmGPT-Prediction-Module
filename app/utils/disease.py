disease_dic = {
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Common_rust_': """ Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Grape___Black_rot': """ Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___healthy': """ Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Grape___Esca_(Black_Measles)': """ Disease: Black Measles<br/>
        <br/> Cause of disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ Disease: Leaf Blight<br/>
        <br/> Cause of disease:
    ...
    'Grape___healthy': """ Disease: No disease<br/>
    ...
    'Raspberry___healthy': """ Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soybean___healthy': """ Disease: No disease<br/>
    ...
    'Tomato___Septoria_leaf_spot': """ Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': """ Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
